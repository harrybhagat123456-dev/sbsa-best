...
def register_authorisation_handlers(bot):
    bot.on_message(filters.command("addauth") & filters.private)(add_auth_user)
    bot.on_message(filters.command("users") & filters.private)(list_auth_users)
    bot.on_message(filters.command("rmauth") & filters.private)(remove_auth_user)
