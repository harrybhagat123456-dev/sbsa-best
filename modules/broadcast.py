...
def register_broadcast_handlers(bot):
    bot.on_message(filters.command("broadcast") & filters.private)(broadcast_handler)
    bot.on_message(filters.command("broadusers") & filters.private)(broadusers_handler)
